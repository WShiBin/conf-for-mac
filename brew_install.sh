...
# Install CMD
brew install maven gradle tree pstree aria2 scala wget go cheat htop neofetch netcat fzf netdata ranger tmux zsh-autosuggestions zsh-completions  maven nginx kafka mycli redis mysql cmatrix jeantil/autokbisw/autokbisw
